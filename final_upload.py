...
merged_data_all.to_csv("Output/model_input.csv", index= "Index", columns=['timestampNs','heartRate','alphaLow','alphaHigh','betaLow','betaHigh','attention','meditation','blinkStrength'])
merged_data_all.to_csv("Flask/user.csv", index= None, columns=['timestampNs','heartRate','alphaLow','alphaHigh','betaLow','betaHigh','attention','meditation','blinkStrength'])
